 ...
 *  ]
 */
app.get(`${BASE_URL}/candidates`, (req, res) => {
 ...
 *
 */
app.get(`${BASE_URL}/candidates/winner`, (req, res) => {
 ...
 *
 */
app.get(`${BASE_URL}/countdown`, (req, res) => {
 ...
 *
 */
app.post(`${BASE_URL}/candidates/vote`, (req, res) => {
